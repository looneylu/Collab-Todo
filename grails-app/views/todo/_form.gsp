...
<div class="fieldcontain ${hasErrors(bean: todoInstance, field: 'lastModifiedDate', 'error')} required">
	<label for="lastModifiedDate">
		<g:message code="todo.lastModifiedDate.label" default="Last Modified Date" />
		<span class="required-indicator">*</span>
	</label>
	<g:datePicker name="lastModifiedDate" precision="day"  value="${todoInstance?.lastModifiedDate}"  />
