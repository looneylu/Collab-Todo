	...
	<body>
		...
		<div id="show-todo" class="content scaffold-show" role="main">
			...
			<ol class="property-list todo">
				...
				<g:if test="${todoInstance?.lastModifiedDate}">
				<li class="fieldcontain">
					<span id="lastModifiedDate-label" class="property-label"><g:message code="todo.lastModifiedDate.label" default="Last Modified Date" /></span>
					
						<span class="property-value" aria-labelledby="lastModifiedDate-label"><g:formatDate date="${todoInstance?.lastModifiedDate}" /></span>
